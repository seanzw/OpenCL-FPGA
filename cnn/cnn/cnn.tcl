...
create_solution -name cnn -dir FPGA -force
...
add_files -kernel [get_kernels conv1] "cnn.cl"
create_kernel max1 -type clc
add_files -kernel [get_kernels max1] "cnn.cl"
...
run_emulation -flow cpu -args "../../../../../cnn.xml result.xml alpha.xclbin"
