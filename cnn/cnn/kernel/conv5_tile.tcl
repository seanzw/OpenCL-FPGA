...
create_solution -name conv5_tile -dir FPGA -force
...
add_files -kernel [get_kernels conv5] "kernel/conv5_tile.cl"
...
run_emulation -flow cpu -args "../../../../../kernel/conv5_tile.xml result.xml alpha.xclbin"
