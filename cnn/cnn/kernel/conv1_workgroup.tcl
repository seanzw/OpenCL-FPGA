...
create_solution -name conv1_workgroup -dir FPGA -force
...
add_files -kernel [get_kernels conv1] "kernel/conv1_workgroup.cl"
...
run_emulation -flow cpu -args "../../../../../kernel/conv1_workgroup.xml result.xml alpha.xclbin"
