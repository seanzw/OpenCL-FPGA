...
create_solution -name rbf7 -dir FPGA -force
...
add_files -kernel [get_kernels rbf7] "kernel/rbf7.cl"
...
run_emulation -flow cpu -args "../../../../../kernel/rbf7.xml result.xml alpha.xclbin"
