...
create_solution -name conv1_unroll -dir FPGA -force
...
add_files -kernel [get_kernels conv1] "kernel/conv1_unroll.cl"
...
run_emulation -flow cpu -args "../../../../../kernel/conv1_unroll.xml result.xml alpha.xclbin"
