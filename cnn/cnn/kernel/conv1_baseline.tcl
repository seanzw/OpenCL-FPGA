...
create_solution -name conv1_baseline -dir FPGA -force
...
add_files -kernel [get_kernels conv1] "kernel/conv1_baseline.cl"
...
run_emulation -flow cpu -args "../../../../../kernel/conv1_baseline.xml result.xml alpha.xclbin"
