...
create_solution -name conv1_item_pipeline -dir FPGA -force
...
add_files -kernel [get_kernels conv1] "kernel/conv1_item_pipeline.cl"
...
run_emulation -flow cpu -args "../../../../../kernel/conv1_item_pipeline.xml result.xml alpha.xclbin"
