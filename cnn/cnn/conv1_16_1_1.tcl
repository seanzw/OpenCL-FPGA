...
create_solution -name conv1_16_1_1 -dir FPGA -force
...
add_files -kernel [get_kernels conv1] "conv1_16_1_1.cl"
...
run_emulation -flow cpu -args "../../../../../conv1_16_1_1.xml result.xml alpha.xclbin"
